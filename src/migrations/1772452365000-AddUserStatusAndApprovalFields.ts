...
export class AddUserStatusAndApprovalFields1772452365000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query('ALTER TABLE "users" ADD "approved_at" TIMESTAMPTZ');
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query('ALTER TABLE "users" DROP CONSTRAINT "FK_users_approved_by_id"');
    await queryRunner.query('ALTER TABLE "users" DROP COLUMN "rejection_reason"');
