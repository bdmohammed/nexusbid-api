...
export class ImplementRBAC1772452361000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      ...
      await queryRunner.query(
        `ALTER TABLE "users" ADD "account_type" VARCHAR(30) DEFAULT NULL`,
      );

      // 3. Migrate existing data
      await queryRunner.query(
        `UPDATE "users" SET "account_type" = 'user' WHERE "role" = 'customer'`,
      );
      await queryRunner.query(
      ...
      await queryRunner.query(
        `DROP TYPE IF EXISTS "public"."users_admin_role_enum"`,
      );
      ...
      await queryRunner.query(
        `ALTER TABLE "audit_logs" ADD "request_id" VARCHAR(255) DEFAULT NULL`,
      );
      await queryRunner.query(
        `ALTER TABLE "audit_logs" ADD "user_agent" VARCHAR(255) DEFAULT NULL`,
      );
      ...
      await queryRunner.query(
        `CREATE INDEX "idx_permission_modules_slug" ON "permission_modules" ("slug")`,
      );
      await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    try {
      ...
      await queryRunner.query(
        `DROP INDEX IF EXISTS "idx_permission_modules_slug"`,
      );
      ...
      await queryRunner.query(
        `ALTER TABLE "users" ADD "admin_role" "public"."users_admin_role_enum" DEFAULT NULL`,
      );

      // 6. Restore data
      await queryRunner.query(
        `UPDATE "users" SET "role" = 'customer' WHERE "account_type" = 'user'`,
      );
      await queryRunner.query(
        `UPDATE "users" SET "role" = 'admin', "admin_role" = 'super_admin' WHERE "account_type" = 'admin'`,
      );
