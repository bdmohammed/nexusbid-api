...
export const adminDelete = asyncHandler(async (req: Request, res: Response) => {
  const { id } = req.params;
  const tender = await AppDataSource.getRepository(Tender).findOne({
    where: { id },
  });
  if (tender) {
...
export const adminGetUploadUrl = asyncHandler(
  async (req: Request, res: Response) => {
...
export const adminRegisterDocument = asyncHandler(
  async (req: Request, res: Response) => {
...
export const cancelTender = asyncHandler(
  async (req: Request, res: Response) => {
    const { id } = req.params;
...
export const duplicateTender = asyncHandler(
  async (req: Request, res: Response) => {
    const { id } = req.params;
    ...
    const dto: CreateTenderDto = {
      ...
      siteVisitDate:
        original.activeVersion.siteVisitDate?.toISOString() || null,
      siteVisitInstructions:
        original.activeVersion.siteVisitInstructions || undefined,
      contactPerson: original.activeVersion.contactPerson || undefined,
      contactDesignation:
        original.activeVersion.contactDesignation || undefined,
      contactEmail: original.activeVersion.contactEmail || undefined,
      contactPhone: original.activeVersion.contactPhone || undefined,
      contactAlternative:
        original.activeVersion.contactAlternative || undefined,
      ...
      eligibilityCriteria:
        original.activeVersion.eligibilityCriteria || undefined,
...
export const scheduleTender = asyncHandler(
  async (req: Request, res: Response) => {
    const { id } = req.params;
...
export const postQuestion = asyncHandler(
  async (req: Request, res: Response) => {
...
export const postClarification = asyncHandler(
  async (req: Request, res: Response) => {
...
export const postAmendment = asyncHandler(
  async (req: Request, res: Response) => {
...
export const assignReviewers = asyncHandler(
  async (req: Request, res: Response) => {
...
export const submitReviewComment = asyncHandler(
  async (req: Request, res: Response) => {
    const dto = req.validated as SubmitReviewCommentDto;
    const { reviewId } = req.params;
    const comment = await service.submitReviewComment(
      reviewId,
      dto,
      req.user!.userId,
    );
...
export const assignCommittee = asyncHandler(
  async (req: Request, res: Response) => {
...
export const submitEvaluation = asyncHandler(
  async (req: Request, res: Response) => {
    ...
    const evalRow = await service.submitEvaluation(
      participantId,
      dto,
      req.user!.userId,
    );
...
export const toggleWatcher = asyncHandler(
  async (req: Request, res: Response) => {
...
export const inviteVendor = asyncHandler(
  async (req: Request, res: Response) => {
...
export const saveTemplate = asyncHandler(
  async (req: Request, res: Response) => {
