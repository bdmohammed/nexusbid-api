...
export const rolesModule: ModuleDefinition = {
  ...
  permissions: [
    ...
    },
    {
      ...
      displayOrder: 7,
      action: 'manage',
      description: 'Activate inactive roles.',
      dependencies: {
        allOf: ['role.view'],
      },
      introducedIn: '1.0.0',
    ...
    },
    {
      ...
      dependencies: {
        allOf: ['role.view', 'permission.view'],
      },
      introducedIn: '1.0.0',
    },
    {
    ...
    },
    {
      ...
      displayOrder: 11,
      action: 'export',
      description: 'Export role definitions.',
      dependencies: {
        allOf: ['role.view'],
      },
      introducedIn: '1.0.0',
    },
    {
      ...
      displayOrder: 12,
      action: 'view',
      description: 'View role change history and audit logs.',
      dependencies: {
        allOf: ['role.view'],
      },
      introducedIn: '1.0.0',
