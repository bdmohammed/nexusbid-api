...
export const permissionManagementModule: ModuleDefinition = {
  ...
  permissions: [
    ...
    },
    {
      ...
      displayOrder: 5,
      action: 'restore',
      description: 'Restore deleted permissions.',
      isSystem: true,
      dependencies: {
        allOf: ['permission.view', 'permission.delete'],
      },
      introducedIn: '1.0.0',
    },
    {
    ...
    },
    {
      ...
      displayOrder: 7,
      action: 'manage',
      description: 'Synchronize registry definitions with the database.',
      isSystem: true,
      dependencies: {
        allOf: ['permission.view'],
      },
    ...
    },
    {
      ...
      displayOrder: 8,
      action: 'manage',
      description: 'Review newly introduced permissions before assigning them to business roles.',
      isSystem: true,
      dependencies: {
        allOf: ['permission.view'],
      },
    ...
    },
    {
      ...
      displayOrder: 9,
      action: 'manage',
      description: 'Create, update and organize permission modules.',
      isSystem: true,
      dependencies: {
        allOf: ['permission.view'],
      },
