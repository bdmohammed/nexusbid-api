...
export const systemModule: ModuleDefinition = {
  ...
  permissions: [
    ...
    },
    {
      ...
      displayOrder: 5,
      action: 'manage',
      description: 'Run, stop and monitor scheduled jobs.',
      dependencies: {
        allOf: ['system.view'],
      },
      isSystem: true,
    ...
    },
    {
      ...
      displayOrder: 10,
      action: 'manage',
      description: 'Configure payment providers and credentials.',
      dependencies: {
        allOf: ['system.view'],
      },
      isSystem: true,
    ...
    },
    {
      ...
      displayOrder: 12,
      action: 'manage',
      description: 'Manage security policies, password rules and authentication settings.',
      dependencies: {
        allOf: ['system.view'],
      },
      isSystem: true,
    ...
    },
    {
      ...
      displayOrder: 13,
      action: 'manage',
      description: 'Run one-time system initialization.',
      dependencies: {
        allOf: ['system.view'],
      },
      hidden: true,
