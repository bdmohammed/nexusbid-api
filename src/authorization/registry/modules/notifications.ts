// src/authorization/registry/modules/notifications.ts
  ...
  permissions: [
    {
      ...
      description:
        "View system notifications and notification history.",
...

    {
      ...
      description:
        "Modify notification content before sending.",
...

    {
      ...
      description:
        "Manage email, SMS, push and in-app notification preferences.",
...

    {
      ...
      description:
        "View notification delivery history and audit logs.",
